...
import type { GetVectorResponse } from './solomon.js';
import type { GetVectorRequest } from './solomon.js';
...
export interface ISolomonServiceClient {
  /**
   * @generated from protobuf rpc: GetVector(me.sylver.marver.solomon.GetVectorRequest) returns (me.sylver.marver.solomon.GetVectorResponse);
   */
  ...
  detectFaces(
    ...
    options?: RpcOptions,
  ): UnaryCall<DetectFacesRequest, DetectFacesResponse>;
  /**
...
export class SolomonServiceClient implements ISolomonServiceClient, ServiceInfo {
  ...
  detectFaces(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<DetectFacesRequest, DetectFacesResponse>(
      'unary',
      this._transport,
      method,
      opt,
