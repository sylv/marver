...
/**
 * @generated from protobuf message me.sylver.marver.solomon.GetVectorRequest
 */
...
/**
 * @generated from protobuf message me.sylver.marver.solomon.GetVectorResponse
 */
export interface GetVectorResponse {
  /**
   * @generated from protobuf field: me.sylver.marver.solomon.Vector vector = 1;
   */
  vector?: Vector;
}
/**
...
export interface Face {
  ...
  /**
   * @generated from protobuf field: me.sylver.marver.solomon.Vector vector = 2;
   */
  vector?: Vector;
  /**
...
/**
 * @generated from protobuf message me.sylver.marver.solomon.Vector
 */
...
class GetVectorRequest$Type extends MessageType<GetVectorRequest> {
  constructor() {
    super('me.sylver.marver.solomon.GetVectorRequest', [
      {
        no: 4,
        name: 'file_path',
        kind: 'scalar',
  ...
  create(value?: PartialMessage<GetVectorRequest>): GetVectorRequest {
    ...
    if (value !== undefined) reflectionMergePartial<GetVectorRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
...
/**
 * @generated MessageType for protobuf message me.sylver.marver.solomon.GetVectorRequest
 */
...
class GetVectorResponse$Type extends MessageType<GetVectorResponse> {
  constructor() {
    super('me.sylver.marver.solomon.GetVectorResponse', [
  ...
  create(value?: PartialMessage<GetVectorResponse>): GetVectorResponse {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<GetVectorResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* me.sylver.marver.solomon.Vector vector */ 1:
  ...
  internalBinaryWrite(
    ...
    /* me.sylver.marver.solomon.Vector vector = 1; */
    if (message.vector)
      Vector.internalBinaryWrite(
        message.vector,
...
/**
 * @generated MessageType for protobuf message me.sylver.marver.solomon.GetVectorResponse
 */
...
class DetectFacesRequest$Type extends MessageType<DetectFacesRequest> {
  ...
  create(value?: PartialMessage<DetectFacesRequest>): DetectFacesRequest {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<DetectFacesRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    /* string file_path = 1; */
    if (message.file_path !== '') writer.tag(1, WireType.LengthDelimited).string(message.file_path);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class DetectFacesResponse$Type extends MessageType<DetectFacesResponse> {
  ...
  create(value?: PartialMessage<DetectFacesResponse>): DetectFacesResponse {
    const message = { faces: [] };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<DetectFacesResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Face$Type extends MessageType<Face> {
  ...
  create(value?: PartialMessage<Face>): Face {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<Face>(this, message, value);
    return message;
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* me.sylver.marver.solomon.BoundingBox bounding_box */ 1:
          message.bounding_box = BoundingBox.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
          ...
          break;
        case /* me.sylver.marver.solomon.Vector vector */ 2:
          message.vector = Vector.internalBinaryRead(reader, reader.uint32(), options, message.vector);
          break;
  ...
  internalBinaryWrite(message: Face, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.bounding_box)
      BoundingBox.internalBinaryWrite(
        message.bounding_box,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
    /* me.sylver.marver.solomon.Vector vector = 2; */
    if (message.vector)
      Vector.internalBinaryWrite(
        message.vector,
    ...
    /* float confidence = 3; */
    if (message.confidence !== 0) writer.tag(3, WireType.Bit32).float(message.confidence);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class BoundingBox$Type extends MessageType<BoundingBox> {
  ...
  create(value?: PartialMessage<BoundingBox>): BoundingBox {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<BoundingBox>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    /* float x1 = 1; */
    if (message.x1 !== 0) writer.tag(1, WireType.Bit32).float(message.x1);
    /* float y1 = 2; */
    if (message.y1 !== 0) writer.tag(2, WireType.Bit32).float(message.y1);
    /* float x2 = 3; */
    if (message.x2 !== 0) writer.tag(3, WireType.Bit32).float(message.x2);
    /* float y2 = 4; */
    if (message.y2 !== 0) writer.tag(4, WireType.Bit32).float(message.y2);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Vector$Type extends MessageType<Vector> {
  constructor() {
    super('me.sylver.marver.solomon.Vector', [
...
/**
 * @generated MessageType for protobuf message me.sylver.marver.solomon.Vector
 */
...
class GetOCRRequest$Type extends MessageType<GetOCRRequest> {
  ...
  create(value?: PartialMessage<GetOCRRequest>): GetOCRRequest {
    const message = { file_path: '' };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<GetOCRRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class GetOCRResponse$Type extends MessageType<GetOCRResponse> {
  ...
  create(value?: PartialMessage<GetOCRResponse>): GetOCRResponse {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<GetOCRResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class OCR$Type extends MessageType<OCR> {
  ...
  create(value?: PartialMessage<OCR>): OCR {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<OCR>(this, message, value);
    return message;
  }
