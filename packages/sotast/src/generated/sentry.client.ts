...
import type { GetOCRResponse } from "./sentry.js";
import type { GetOCRRequest } from "./sentry.js";
...
export interface ISentryServiceClient {
    ...
    /**
     * @generated from protobuf rpc: GetOCR(me.sylver.marver.sentry.GetOCRRequest) returns (me.sylver.marver.sentry.GetOCRResponse);
     */
