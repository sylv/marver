...
/**
 * @generated from protobuf message me.sylver.marver.sentry.GetOCRRequest
 */
...
/**
 * @generated from protobuf message me.sylver.marver.sentry.GetOCRResponse
 */
export interface GetOCRResponse {
    /**
     * @generated from protobuf field: repeated me.sylver.marver.sentry.OCR results = 1;
     */
    results: OCR[];
}
/**
 * @generated from protobuf message me.sylver.marver.sentry.OCR
 */
export interface OCR {
    ...
    text: string;
    /**
     * @generated from protobuf field: me.sylver.marver.sentry.BoundingBox bounding_box = 2;
     */
    bounding_box?: BoundingBox;
    /**
     * @generated from protobuf field: float confidence = 3;
...
class GetOCRRequest$Type extends MessageType<GetOCRRequest> {
    constructor() {
        super("me.sylver.marver.sentry.GetOCRRequest", [
            { no: 1, name: "file_path", kind: "scalar", localName: "file_path", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message me.sylver.marver.sentry.GetOCRRequest
 */
export const GetOCRRequest = new GetOCRRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetOCRResponse$Type extends MessageType<GetOCRResponse> {
    constructor() {
        super("me.sylver.marver.sentry.GetOCRResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetOCRResponse): GetOCRResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated me.sylver.marver.sentry.OCR results */ 1:
    ...
    internalBinaryWrite(message: GetOCRResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated me.sylver.marver.sentry.OCR results = 1; */
...
/**
 * @generated MessageType for protobuf message me.sylver.marver.sentry.GetOCRResponse
 */
export const GetOCRResponse = new GetOCRResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OCR$Type extends MessageType<OCR> {
    constructor() {
        super("me.sylver.marver.sentry.OCR", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string text */ 1:
                    ...
                    break;
                case /* me.sylver.marver.sentry.BoundingBox bounding_box */ 2:
                    message.bounding_box = BoundingBox.internalBinaryRead(reader, reader.uint32(), options, message.bounding_box);
                    break;
                case /* float confidence */ 3:
                    message.confidence = reader.float();
    ...
    internalBinaryWrite(message: OCR, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* me.sylver.marver.sentry.BoundingBox bounding_box = 2; */
        if (message.bounding_box)
...
/**
 * @generated MessageType for protobuf message me.sylver.marver.sentry.OCR
 */
