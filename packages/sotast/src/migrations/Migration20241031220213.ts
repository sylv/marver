...
export class Migration20241031220213 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table \`file_embedding\` (\`id\` integer not null primary key autoincrement, \`file_id\` text not null, \`position\` integer null, \`data\` FB16_BLOB(768) not null, constraint \`file_embedding_file_id_foreign\` foreign key(\`file_id\`) references \`files\`(\`id\`) on update cascade);`);
