...
export class Migration20240418180209 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create unique index `file_assets_file_id_unique` on `file_assets` (`file_id`);');
