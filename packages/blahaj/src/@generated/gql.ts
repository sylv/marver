...
const documents = {
    ...
    "query Files($search: String, $after: String) {\n  files(search: $search, after: $after, first: 100) {\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n    edges {\n      node {\n        ...FileParts\n      }\n    }\n  }\n}\n\nfragment FileParts on File {\n  id\n  previewBase64\n  thumbnailUrl\n  path\n  name\n  size\n  sizeFormatted\n  info {\n    height\n    width\n    durationFormatted\n    durationSeconds\n    framerate\n    videoCodec\n    audioCodec\n  }\n}": types.FilesDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query Files($search: String, $after: String) {\n  files(search: $search, after: $after, first: 100) {\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n    edges {\n      node {\n        ...FileParts\n      }\n    }\n  }\n}\n\nfragment FileParts on File {\n  id\n  previewBase64\n  thumbnailUrl\n  path\n  name\n  size\n  sizeFormatted\n  info {\n    height\n    width\n    durationFormatted\n    durationSeconds\n    framerate\n    videoCodec\n    audioCodec\n  }\n}"): (typeof documents)["query Files($search: String, $after: String) {\n  files(search: $search, after: $after, first: 100) {\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n    edges {\n      node {\n        ...FileParts\n      }\n    }\n  }\n}\n\nfragment FileParts on File {\n  id\n  previewBase64\n  thumbnailUrl\n  path\n  name\n  size\n  sizeFormatted\n  info {\n    height\n    width\n    durationFormatted\n    durationSeconds\n    framerate\n    videoCodec\n    audioCodec\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
